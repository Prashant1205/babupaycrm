        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            <div class="navbar-header">
                <a class="navbar-brand" href="/">
                    <b>
                        <img src="/images/logo-icon.png" alt="home" class="dark-logo" width="30px" />
                        <img src="/images/logo-light-icon.png" alt="home" class="light-logo" width="100px" />
                    </b>
                    <span>
                     <img src="/images/logo-text.png" alt="home" class="dark-logo" width="100px"/>
                     <img src="/images/logo-light-text.png" class="light-logo" alt="home" width="100px" /></span> </a>
            </div>
